...
$(document).on('click', '#btn_incluir', function () {
    ...
    .on('click', '.btn-alterar', function () {
        ...
        $.post(url, add_anti_forgery_token(param), function (response) {
            ...
            .fail(function () {
                Swal.fire('Aviso', 'Não foi possivel recuperar as informações. Tente novamente em instantes', 'warning');
            });
    })
            ...
            callback: function (result) {
                if (result) {
                    $.post(url, add_anti_forgery_token(param), function (response) {
                        ...
                        Swal.fire('Aviso', 'Não foi possivel excluir as informações. Tente novamente em instantes', 'warning');
                    });
                }
            }
        });
    ...
    .on('click', '#btn_confirmar', function () {
        ...
        $.post(url, add_anti_forgery_token(param), function (response) {
            ...
            Swal.fire('Aviso', 'Não foi possivel salvar. Tente novamente em instantes', 'warning');
        });
    })
