...
{
	public class MarcaLocaisArmazenamento
	{
		...
		public static List<MarcaLocaisArmazenamento> RecuperarLista(int pagina, int tamPagina)
		{
			var ret = new List<MarcaLocaisArmazenamento>();
			...
			using (var conexao = new SqlConnection())
			{
				...
				using (var comando = new SqlCommand())
				{
					...
					while (reader.Read())
					{
						ret.Add(new MarcaLocaisArmazenamento
						{
							Id = (int)reader["id"],
		...
		public static MarcaLocaisArmazenamento RecuperarPeloId(int id)
		{
			MarcaLocaisArmazenamento ret = null;
			...
			using (var conexao = new SqlConnection())
			{
				...
				using (var comando = new SqlCommand())
				{
					...
					if (reader.Read())
					{
						ret = new MarcaLocaisArmazenamento
						{
							Id = (int)reader["id"],
							Nome = (string)reader["nome"],
							Ativo = (bool)reader["ativo"]
